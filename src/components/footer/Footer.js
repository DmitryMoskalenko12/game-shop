      ...
      <div className="container">
        <div className="footer__wrapcontent">
          ...
          <ul className="footer__catalog">
              ...
              <li className="footer__footlist"><a href="#">Warhammer 40000</a></li>
              <li className="footer__footlist"><a href="#">Настольные игры</a></li>
          ...
          <ul className="footer__aboutus">
            ...
            <li className="footer__listabout"><a href="#">Мероприятия</a></li>
          ...
          <ul className="footer__delivery">
            ...
            <li className="footer__paydel"><a href="#">Гарантия и возврат</a></li>
          </ul>
        ...
        <div className="footer__bottomcontent">
         <div className="footer__blockconfid">
          <div className="footer__magicgold">© 2021 MagicGoldFish.ru</div>
          <div className="footer__confid"><a href="#">Политика конфиденциальности</a></div>
         </div>
          ...
          <div className="footer__offerta">Содержимое не является публичной офертой
            <a href="#"><span> Пользовательское соглашение</span></a></div>
        </div>
      </div>
    </footer>
  )
